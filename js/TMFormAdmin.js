...
$(window).load(function(){
	$('#admin-form').TMFormAdmin({
		recaptchaPublicKey:'6LeZwukSAAAAAG8HbIAE0XeNvCon_cXThgu9afkj'		
	})
})

;(function($){
	$.fn.TMFormAdmin=function(opt){
		return this.each(TMFormAdmin)
		
		function TMFormAdmin(){
			var form=$(this)
			opt=$.extend({	
					okClass:'ok'
					,emptyClass:'empty'
					...
					,HandlerURL:'bat/adminupdatepage.php'					
