    ...
    <main>        
      ...
      <section class="well well4">
        <div class="container">
		  ...
		  <form  method="post" action="bat/registeruser.php" >
			...
			<label class="last name">
                <input type="text" name="lastname" placeholder="Last Name:" value="" data-constraints="@Required @JustLetters"/>
			</label> 
			...
			<label class="username">
                <input type="text" name="username" placeholder="Username:" value="" data-constraints="@Required"/>
			</label>
